...
export const BUNDESLAENDER: BundeslandInfo[] = [
  ...
  },
  {
    ...
    keinAnspruch: false,
    anerkennungsstelleUrl: 'https://www.berlin.de/sen/arbeit/beschaeftigung/bildungsurlaub/',
    zukuenftig: false,
    gueltigAb: null,
  },
  {
    ...
    besonderheiten: '',
    keinAnspruch: false,
    anerkennungsstelleUrl: 'https://mbjs.brandenburg.de/bildung/weiterbildung/bildungsfreistellung.html',
    zukuenftig: false,
    gueltigAb: null,
  },
  {
    ...
    keinAnspruch: false,
    anerkennungsstelleUrl: 'https://www.senatspressestelle.bremen.de/bildungsurlaub-3374',
    zukuenftig: false,
    gueltigAb: null,
  },
  {
    ...
    besonderheiten: '',
    keinAnspruch: false,
    anerkennungsstelleUrl: 'https://www.hamburg.de/bildungsurlaub',
    zukuenftig: false,
    gueltigAb: null,
  },
  {
  ...
  },
  {
    ...
    keinAnspruch: false,
    anerkennungsstelleUrl: 'https://www.regierung-mv.de/Landesregierung/bm/Bildung/Weiterbildung/Bildungsfreistellung/',
    zukuenftig: false,
    gueltigAb: null,
  },
  {
    ...
    besonderheiten: '',
    keinAnspruch: false,
    anerkennungsstelleUrl: 'https://www.mk.niedersachsen.de/startseite/service/weiterbildung/bildungsurlaub/bildungsurlaub-6410.html',
    zukuenftig: false,
    gueltigAb: null,
  },
  {
    ...
    keinAnspruch: false,
    anerkennungsstelleUrl: 'https://www.mags.nrw/bildungsurlaub',
    zukuenftig: false,
    gueltigAb: null,
  },
  {
    ...
    antragsfrist: '6 Wochen',
    gesetz: 'BFG RP',
    besonderheiten: 'Ausnahme: 2 Jahre Wartezeit! Kleinbetriebsklausel ab unter 5 Beschäftigten.',
    keinAnspruch: false,
    anerkennungsstelleUrl: 'https://mastd.rlp.de/de/themen/weiterbildung/bildungsfreistellung/',
    zukuenftig: false,
    gueltigAb: null,
  },
  {
    ...
    keinAnspruch: false,
    anerkennungsstelleUrl: 'https://www.saarland.de/mbk/DE/portale/weiterbildung/bildungsfreistellung/bildungsfreistellung_node.html',
    zukuenftig: false,
  ...
  },
  {
    ...
    keinAnspruch: false,
    anerkennungsstelleUrl: 'https://ms.sachsen-anhalt.de/themen/arbeit/bildungsfreistellung/',
    zukuenftig: false,
  ...
  },
  {
    ...
    besonderheiten: '',
    keinAnspruch: false,
    anerkennungsstelleUrl: 'https://www.schleswig-holstein.de/DE/fachinhalte/W/weiterbildung/bildungsfreistellung.html',
    zukuenftig: false,
    gueltigAb: null,
  },
  {
    ...
    keinAnspruch: false,
    anerkennungsstelleUrl: 'https://bildung.thueringen.de/erwachsenenbildung/bildungsfreistellung',
    zukuenftig: false,
    gueltigAb: null,
  },
];
