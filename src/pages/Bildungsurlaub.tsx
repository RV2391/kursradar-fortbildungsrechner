      ...
      <div className="container py-12">
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground font-roboto max-w-2xl mx-auto">
            Hast du Anspruch auf bezahlten Bildungsurlaub fuer deine zahnmedizinische Fortbildung?
            Pruefe es in 3 Schritten — mit Kleinbetriebsklausel und Dental-Hinweisen.
          </p>
          <p className="mt-2 text-sm text-muted-foreground/70 font-roboto">
            15 von 16 Bundeslaendern haben ein Bildungsurlaubsgesetz — nur Bayern nicht
          </p>
        </div>
